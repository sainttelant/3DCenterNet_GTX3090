...
extern std::vector<float> prepareImage(cv::Mat& img, const int& forwardFace);
extern void postProcess(std::vector<Detection> & result,const cv::Mat& img, const int& forwardFace);
extern void postProcess(std::vector<Detection> & result,const int &img_w ,const int& img_h, const int& forwardFace);
extern void drawImg(const std::vector<Detection> & result,cv::Mat& img,const std::vector<cv::Scalar>& color, const int& forwardFace);
